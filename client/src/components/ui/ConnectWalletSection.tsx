     ...
     { headerTop && (
      ...
      <div className="flex h-[200px] w-full flex-col items-center justify-center space-y-2 rounded-lg border border-v2-lily/5 mt-3">
        <div className="text-center">
          ...
          <button  onClick={() => setWalletModalOpen(true)} className="border border-transparent px-5 sm:px-6 py-2 text-primary bg-primary/10 text-black rounded-lg font-bold shadow-md transition-all duration-300 hover:border-cyan-400">
            Connect Wallet
          </button>
        </div>
      </div>
